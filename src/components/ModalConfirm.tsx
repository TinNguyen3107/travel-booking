...
export default function ModalConfirm({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-zinc-950/60 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-sm overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl animate-in zoom-in-95 duration-200">
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="p-6 pt-8 text-center">
          ...
          <h2 className="mb-2 text-xl font-black text-zinc-950">{title}</h2>
