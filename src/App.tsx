    ...
    <div className={`min-h-screen font-sans transition-colors duration-300 bg-slate-100 dark:bg-slate-900/70 text-zinc-900 dark:text-slate-100`}>
          ...
          <div>
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <button
                ...
                className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-5 py-3 text-sm font-black text-zinc-800 dark:text-slate-200 hover:bg-zinc-100 dark:hover:bg-slate-800"
              >
                Đăng ký làm host
              </button>
            </div>
      ...
      <section id="experiences" className="bg-zinc-50 dark:bg-slate-900/50 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 flex flex-col gap-3 rounded-2xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 p-4 lg:flex-row lg:items-center">
                ...
                <div className="flex w-full flex-col">
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-3 rounded-full bg-white/80 backdrop-blur-lg dark:bg-slate-800/90 p-2 text-zinc-400 dark:text-slate-500 hover:text-rose-500 shadow-sm"
                    >
                    ...
                    <div className="mt-auto flex flex-col gap-3 border-t border-zinc-100 dark:border-slate-800 pt-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-4 py-2 text-sm font-black text-zinc-600 dark:text-slate-300 hover:bg-zinc-50 dark:hover:bg-slate-900/50"
                        >
                          Chi tiết
                        </button>
                        <button
      ...
      <section id="reviews" className="bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <form onSubmit={submitReview} className="mt-6 space-y-4 rounded-2xl border border-zinc-200 dark:border-slate-700 bg-zinc-50 dark:bg-slate-900/50 p-5">
              <select
                ...
                className="w-full rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm font-bold text-zinc-700 dark:text-slate-200 outline-none focus:border-emerald-500"
              >
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((value) => (
                  <button
                    ...
                    className={`rounded-lg border p-2 ${reviewRating >= value ? 'border-amber-200 bg-amber-50 text-amber-500' : 'border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 text-zinc-300'}`}
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500"
              />
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500"
              />

              {reviewMessage && (
                <div className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 p-3 text-sm font-semibold text-zinc-700 dark:text-slate-200">
                  {reviewMessage}
                </div>
              )}
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            ...
            <form onSubmit={submitHostApplication} className="mt-6 grid gap-3 rounded-2xl border border-zinc-200 dark:border-slate-700 bg-zinc-50 dark:bg-slate-900/50 p-5">
              <input value={hostForm.name} onChange={(event) => setHostForm((current) => ({ ...current, name: event.target.value }))} placeholder="Họ tên" className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
              <div className="grid gap-3 sm:grid-cols-2">
                <input value={hostForm.email} onChange={(event) => setHostForm((current) => ({ ...current, email: event.target.value }))} placeholder="Email" className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
                <input value={hostForm.phone} onChange={(event) => setHostForm((current) => ({ ...current, phone: event.target.value }))} placeholder="Số điện thoại" className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
              </div>
              <input value={hostForm.address} onChange={(event) => setHostForm((current) => ({ ...current, address: event.target.value }))} placeholder="Địa chỉ (VD: 123 Nguyễn Văn Cừ, Q.5, TP.HCM)" className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
              <div className="grid gap-3 sm:grid-cols-2">
                <input value={hostForm.id_number} onChange={(event) => setHostForm((current) => ({ ...current, id_number: event.target.value.replace(/\D/g, '').slice(0, 12) }))} placeholder="Số CCCD/Passport (12 số)" maxLength={12} className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
                <input value={hostForm.experience_location} onChange={(event) => setHostForm((current) => ({ ...current, experience_location: event.target.value }))} placeholder="Địa điểm trải nghiệm (VD: Vịnh Hạ Long, Hội An)" className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
              </div>
              <textarea value={hostForm.description} onChange={(event) => setHostForm((current) => ({ ...current, description: event.target.value }))} rows={4} placeholder="Bạn muốn tổ chức trải nghiệm gì? Mô tả tối thiểu 20 ký tự." className="resize-none rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-2.5 text-sm outline-none focus:border-emerald-500" />
              {hostMessage && (
                <div className="rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 p-3 text-sm font-semibold text-zinc-700 dark:text-slate-200">
                  {hostMessage}
                </div>
          ...
          <div className="rounded-2xl">
            <div className="rounded-2xl border border-zinc-200 dark:border-slate-700 p-5 bg-white/80 backdrop-blur-lg dark:bg-slate-800">
...
function FeatureCard({
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 p-5">
...
function HeroStat({
  ...
  return (
    <div className="flex items-center justify-center gap-2 rounded-xl border border-zinc-200 dark:border-slate-700 bg-white/80 backdrop-blur-lg dark:bg-slate-800 px-3 py-3 text-sm font-black text-zinc-800 dark:text-slate-200">
