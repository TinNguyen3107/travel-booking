  ...
  public async ensureSchema(): Promise<void> {
    ...
    await pool.query(`
      CREATE TABLE IF NOT EXISTS bookings (
        ...
        status ENUM('pending', 'confirmed', 'checked_in', 'completed', 'no_show', 'cancelled') NOT NULL DEFAULT 'pending',
    ...
    try { await pool.query("ALTER TABLE bookings MODIFY COLUMN status ENUM('pending', 'confirmed', 'checked_in', 'completed', 'no_show', 'cancelled') NOT NULL DEFAULT 'pending'"); } catch (e: any) { }
